package com.astechnologies.memhut.post;
...
import com.astechnologies.memhut.adapter.AdapterComments;
import com.astechnologies.memhut.groups.ShareGroupActivity;
import com.astechnologies.memhut.model.ModelComments;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.astechnologies.memhut.fileprovider", file);
